...
/**
 * PermanentAuthorizationInfo Class Doc Comment
 *
 * @category Class
 * @package  Coucounco\Airkey\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PermanentAuthorizationInfo extends AuthorizationInfo 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PermanentAuthorizationInfo';
     ...
     * Sets type
     *
     * @param string $type Permanent type of authorization
     *
     * @return $this
     */
     ...
     *
     * @param string $valid_from_date Date from when the authorization is valid regardless of the time zone, not necessary if it should always be valid (ISO 8601-format compliant date without time zone: yyyy-mm-dd)
     *
     * @return $this
     */
     ...
     * Sets valid_to_date
     *
     * @param string $valid_to_date Date until when the authorization is valid regardless of the time zone, not necessary if it should always be valid (ISO 8601-format compliant date without time zone: yyyy-mm-dd)
     *
     * @return $this
     */
