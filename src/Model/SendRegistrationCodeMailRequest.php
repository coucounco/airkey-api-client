...
/**
 * SendRegistrationCodeMailRequest Class Doc Comment
 *
 * @category Class
 * @description Model that describes a send registration code via mail request.
 * @package  Coucounco\Airkey\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SendRegistrationCodeMailRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SendRegistrationCodeMailRequest';
    ...
    public function setMailText($mail_text)
    {
        if (!is_null($mail_text) && (mb_strlen($mail_text) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $mail_text when calling SendRegistrationCodeMailRequest., must be smaller than or equal to 2048.');
        }
        if (!is_null($mail_text) && (mb_strlen($mail_text) < 0)) {
            throw new \InvalidArgumentException('invalid length for $mail_text when calling SendRegistrationCodeMailRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMailSubject($mail_subject)
    {
        if (!is_null($mail_subject) && (mb_strlen($mail_subject) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mail_subject when calling SendRegistrationCodeMailRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($mail_subject) && (mb_strlen($mail_subject) < 0)) {
            throw new \InvalidArgumentException('invalid length for $mail_subject when calling SendRegistrationCodeMailRequest., must be bigger than or equal to 0.');
        }
