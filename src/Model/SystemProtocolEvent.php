...
class SystemProtocolEvent implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_ACTIVATE_AUTOMATIC_MOBILE_PHONE_REPLACEMENT_APPROVAL = 'ACTIVATE_AUTOMATIC_MOBILE_PHONE_REPLACEMENT_APPROVAL';
    ...
    const TYPE_API_DEACTIVATE_KEY = 'API_DEACTIVATE_KEY';
    const TYPE_API_DELETE_KEY = 'API_DELETE_KEY';
    const TYPE_API_GENERATE_KEY = 'API_GENERATE_KEY';
    const TYPE_API_PURCHASE_ACCESS = 'API_PURCHASE_ACCESS';
    const TYPE_API_REACTIVATE_KEY = 'API_REACTIVATE_KEY';
    const TYPE_API_REGENERATE_KEY = 'API_REGENERATE_KEY';
    const TYPE_API_UPDATE_KEY = 'API_UPDATE_KEY';
    const TYPE_APP_UPDATE_AFTER_UNLOCKING_ACTIVATED = 'APP_UPDATE_AFTER_UNLOCKING_ACTIVATED';
    const TYPE_APP_UPDATE_AFTER_UNLOCKING_DEACTIVATED = 'APP_UPDATE_AFTER_UNLOCKING_DEACTIVATED';
    ...
    const TYPE_DEACTIVATE_AUTOMATIC_MOBILE_PHONE_REPLACEMENT_APPROVAL = 'DEACTIVATE_AUTOMATIC_MOBILE_PHONE_REPLACEMENT_APPROVAL';
    ...
    const TYPE_FOUR_EYES_DISABLED = 'FOUR_EYES_DISABLED';
    const TYPE_FOUR_EYES_DISABLE_EMAIL_SENT = 'FOUR_EYES_DISABLE_EMAIL_SENT';
    const TYPE_FOUR_EYES_ENABLED = 'FOUR_EYES_ENABLED';
    const TYPE_FOUR_EYES_ENABLE_EMAIL_SENT = 'FOUR_EYES_ENABLE_EMAIL_SENT';
    const TYPE_FOUR_EYES_INVALID_TOKEN = 'FOUR_EYES_INVALID_TOKEN';
    const TYPE_FOUR_EYES_UNLOCKED = 'FOUR_EYES_UNLOCKED';
    const TYPE_FOUR_EYES_UNLOCK_EMAIL_SENT = 'FOUR_EYES_UNLOCK_EMAIL_SENT';
    ...
    const TYPE_JOURNAL_EXPORT_FETCHED = 'JOURNAL_EXPORT_FETCHED';
    const TYPE_JOURNAL_EXPORT_PREPARED = 'JOURNAL_EXPORT_PREPARED';
    const TYPE_KEYRING_PROTOCOL_EXPORTED = 'KEYRING_PROTOCOL_EXPORTED';
    const TYPE_KEYRING_PROTOCOL_EXPORT_FETCHED = 'KEYRING_PROTOCOL_EXPORT_FETCHED';
    const TYPE_KEYRING_PROTOCOL_EXPORT_PREPARED = 'KEYRING_PROTOCOL_EXPORT_PREPARED';
    const TYPE_KEY_RING_REPLACEMENT_OF_KEY_CARD_ABORTED_BY_ACO = 'KEY_RING_REPLACEMENT_OF_KEY_CARD_ABORTED_BY_ACO';
    const TYPE_KEY_RING_REPLACEMENT_OF_KEY_CARD_FINISHED = 'KEY_RING_REPLACEMENT_OF_KEY_CARD_FINISHED';
    const TYPE_KEY_RING_REPLACEMENT_OF_KEY_CARD_STARTED = 'KEY_RING_REPLACEMENT_OF_KEY_CARD_STARTED';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_ABORTED_BY_ACO = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_ABORTED_BY_ACO';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_ABORTED_BY_USER = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_ABORTED_BY_USER';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_AUTOMATICALLY_APPROVED = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_AUTOMATICALLY_APPROVED';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_FINISHED = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_FINISHED';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_MANUALLY_APPROVED = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_MANUALLY_APPROVED';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_MANUALLY_REJECTED = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_MANUALLY_REJECTED';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_STARTED_BY_ACO = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_STARTED_BY_ACO';
    const TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_STARTED_BY_USER = 'KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_STARTED_BY_USER';
    const TYPE_LOCKING_COMPONENT_PROTOCOL_EXPORTED = 'LOCKING_COMPONENT_PROTOCOL_EXPORTED';
    const TYPE_LOCKING_COMPONENT_PROTOCOL_EXPORT_FETCHED = 'LOCKING_COMPONENT_PROTOCOL_EXPORT_FETCHED';
    const TYPE_LOCKING_COMPONENT_PROTOCOL_EXPORT_PREPARED = 'LOCKING_COMPONENT_PROTOCOL_EXPORT_PREPARED';
    const TYPE_LOGIN_FAILED_FIRST_FACTOR = 'LOGIN_FAILED_FIRST_FACTOR';
    const TYPE_LOGIN_FAILED_SECOND_FACTOR = 'LOGIN_FAILED_SECOND_FACTOR';
    ...
    const TYPE_SMS_TEXT = 'SMS_TEXT';
    const TYPE_TEMPORAL_CREDIT_ADDED = 'TEMPORAL_CREDIT_ADDED';
    const TYPE_TWO_FACTOR_AUTH_DISABLED = 'TWO_FACTOR_AUTH_DISABLED';
    const TYPE_TWO_FACTOR_AUTH_ENABLED = 'TWO_FACTOR_AUTH_ENABLED';
    ...
    const TYPE_USE_DEFAULT_SMS_TEXT_ACTIVATED = 'USE_DEFAULT_SMS_TEXT_ACTIVATED';
    const TYPE_USE_DEFAULT_SMS_TEXT_DEACTIVATED = 'USE_DEFAULT_SMS_TEXT_DEACTIVATED';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_ACTIVATE_AUTOMATIC_MOBILE_PHONE_REPLACEMENT_APPROVAL,
            self::TYPE_ADD_SUPPORT_ACO,
            self::TYPE_ALL_LOCKING_SYSTEM_LOGS_OF_A_PERSON_DELETED,
            self::TYPE_API_DEACTIVATE_KEY,
            self::TYPE_API_DELETE_KEY,
            self::TYPE_API_GENERATE_KEY,
            self::TYPE_API_PURCHASE_ACCESS,
            self::TYPE_API_REACTIVATE_KEY,
            self::TYPE_API_REGENERATE_KEY,
            self::TYPE_API_UPDATE_KEY,
            self::TYPE_APP_UPDATE_AFTER_UNLOCKING_ACTIVATED,
            self::TYPE_APP_UPDATE_AFTER_UNLOCKING_DEACTIVATED,
            ...
            self::TYPE_DEACTIVATE_AUTOMATIC_MOBILE_PHONE_REPLACEMENT_APPROVAL,
            ...
            self::TYPE_FOUR_EYES_DISABLED,
            self::TYPE_FOUR_EYES_DISABLE_EMAIL_SENT,
            self::TYPE_FOUR_EYES_ENABLED,
            self::TYPE_FOUR_EYES_ENABLE_EMAIL_SENT,
            self::TYPE_FOUR_EYES_INVALID_TOKEN,
            self::TYPE_FOUR_EYES_UNLOCKED,
            self::TYPE_FOUR_EYES_UNLOCK_EMAIL_SENT,
            ...
            self::TYPE_JOURNAL_EXPORT_FETCHED,
            self::TYPE_JOURNAL_EXPORT_PREPARED,
            self::TYPE_KEYRING_PROTOCOL_EXPORTED,
            self::TYPE_KEYRING_PROTOCOL_EXPORT_FETCHED,
            self::TYPE_KEYRING_PROTOCOL_EXPORT_PREPARED,
            self::TYPE_KEY_RING_REPLACEMENT_OF_KEY_CARD_ABORTED_BY_ACO,
            self::TYPE_KEY_RING_REPLACEMENT_OF_KEY_CARD_FINISHED,
            self::TYPE_KEY_RING_REPLACEMENT_OF_KEY_CARD_STARTED,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_ABORTED_BY_ACO,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_ABORTED_BY_USER,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_AUTOMATICALLY_APPROVED,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_FINISHED,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_MANUALLY_APPROVED,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_MANUALLY_REJECTED,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_STARTED_BY_ACO,
            self::TYPE_KEY_RING_REPLACEMENT_OF_MOBILE_PHONE_STARTED_BY_USER,
            self::TYPE_LOCKING_COMPONENT_PROTOCOL_EXPORTED,
            self::TYPE_LOCKING_COMPONENT_PROTOCOL_EXPORT_FETCHED,
            self::TYPE_LOCKING_COMPONENT_PROTOCOL_EXPORT_PREPARED,
            self::TYPE_LOGIN_FAILED_FIRST_FACTOR,
            self::TYPE_LOGIN_FAILED_SECOND_FACTOR,
            ...
            self::TYPE_TWO_FACTOR_AUTH_DISABLED,
            self::TYPE_TWO_FACTOR_AUTH_ENABLED,
            ...
            self::TYPE_USE_DEFAULT_SMS_TEXT_ACTIVATED,
            self::TYPE_USE_DEFAULT_SMS_TEXT_DEACTIVATED,
            self::TYPE_VIEW_LOG,
        ];
    }
