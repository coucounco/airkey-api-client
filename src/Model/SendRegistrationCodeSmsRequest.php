...
/**
 * SendRegistrationCodeSmsRequest Class Doc Comment
 *
 * @category Class
 * @description Model that describes a send registration code via SMS request.
 * @package  Coucounco\Airkey\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SendRegistrationCodeSmsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SendRegistrationCodeSmsRequest';
    ...
    public function setSmsText($sms_text)
    {
        if (!is_null($sms_text) && (mb_strlen($sms_text) > 150)) {
            throw new \InvalidArgumentException('invalid length for $sms_text when calling SendRegistrationCodeSmsRequest., must be smaller than or equal to 150.');
        }
        if (!is_null($sms_text) && (mb_strlen($sms_text) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sms_text when calling SendRegistrationCodeSmsRequest., must be bigger than or equal to 0.');
        }
