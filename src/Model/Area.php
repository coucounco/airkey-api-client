...
class Area implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'comment' => 'string',
        'lock_list' => '\Coucounco\Airkey\Swagger\Client\Model\Lock[]'
    ];
     ...
     * Sets lock_list
     *
     * @param \Coucounco\Airkey\Swagger\Client\Model\Lock[] $lock_list List of locks that are assigned to the area
     *
     * @return $this
     */
