...
class PersonCreate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PersonCreate';
    ...
    public function setFirstName($first_name)
    {
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling PersonCreate., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($first_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setLastName($last_name)
    {
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling PersonCreate., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setSecondaryIdentification($secondary_identification)
    {
        if (!is_null($secondary_identification) && (mb_strlen($secondary_identification) > 50)) {
            throw new \InvalidArgumentException('invalid length for $secondary_identification when calling PersonCreate., must be smaller than or equal to 50.');
        }
        if (!is_null($secondary_identification) && (mb_strlen($secondary_identification) < 0)) {
            throw new \InvalidArgumentException('invalid length for $secondary_identification when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PersonCreate., must be smaller than or equal to 50.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        if (!is_null($email_address) && (mb_strlen($email_address) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling PersonCreate., must be smaller than or equal to 50.');
        }
        if (!is_null($email_address) && (mb_strlen($email_address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 50)) {
            throw new \InvalidArgumentException('invalid length for $street when calling PersonCreate., must be smaller than or equal to 50.');
        }
        if (!is_null($street) && (mb_strlen($street) < 0)) {
            throw new \InvalidArgumentException('invalid length for $street when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling PersonCreate., must be smaller than or equal to 10.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if (!is_null($country_code) && (mb_strlen($country_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling PersonCreate., must be smaller than or equal to 3.');
        }
        if (!is_null($country_code) && (mb_strlen($country_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PersonCreate., must be smaller than or equal to 50.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 500)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling PersonCreate., must be smaller than or equal to 500.');
        }
        if (!is_null($comment) && (mb_strlen($comment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling PersonCreate., must be bigger than or equal to 0.');
        }
    ...
    public function setCorrespondenceLanguageCode($correspondence_language_code)
    {
        ...
        if ((mb_strlen($correspondence_language_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $correspondence_language_code when calling PersonCreate., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($correspondence_language_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $correspondence_language_code when calling PersonCreate., must be bigger than or equal to 0.');
        }
