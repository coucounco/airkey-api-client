...
/**
 * HolidayCalendarSeries Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HolidayCalendarSeries implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HolidayCalendarSeries';
     ...
     * Sets ends_on
     *
     * @param string $ends_on Day until when the series is valid regardless of the time zone (ISO 8601-format compliant date without time zone: yyyy-mm-dd)
     *
     * @return $this
     */
