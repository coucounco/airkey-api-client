...
class SystemProtocolApi
{
     ...
     * @return \Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList
     */
     ...
     * @throws \Coucounco\Airkey\Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList',
    ...
    /**
     * Operation getSystemProtocolLimited
     *
     ...
     * @param  int $user_id Filter events by unique administrator user identifier (optional)
     * @param  string $administrator Filter events by name of administrator (optional)
     * @param  string $from Timestamp from when the protocol entries need to be considered (inclusive, ISO 8601-format compliant date with time in UTC, milliseconds precision: yyyy-mm-ddThh:mm:ss.SSSZ) (optional)
     * @param  string $to Timestamp until when the protocol entries need to be considered (inclusive, ISO 8601-format compliant date with time in UTC, milliseconds precision: yyyy-mm-ddThh:mm:ss.SSSZ) (optional)
     * @param  string $language Language codes as a comma-separated list of IETF (bcp47) language tags (e.g. de-DE, en-UK) or \&quot;all\&quot; for all possible languages used for translations (optional, default to de-DE)
     *
     * @throws \Coucounco\Airkey\Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList
     */
    public function getSystemProtocolLimited($offset = null, $limit = null, $id = null, $lock_id = null, $medium_id = null, $event = null, $user_id = null, $administrator = null, $from = null, $to = null, $language = 'de-DE')
    {
        list($response) = $this->getSystemProtocolLimitedWithHttpInfo($offset, $limit, $id, $lock_id, $medium_id, $event, $user_id, $administrator, $from, $to, $language);
        return $response;
    }

    /**
     * Operation getSystemProtocolLimitedWithHttpInfo
     *
     * Gets system protocol.
     *
     * @param  int $offset Offset for paging (optional)
     ...
     * @return array of \Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSystemProtocolLimitedWithHttpInfo($offset = null, $limit = null, $id = null, $lock_id = null, $medium_id = null, $event = null, $user_id = null, $administrator = null, $from = null, $to = null, $language = 'de-DE')
    {
        $returnType = '\Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList';
        $request = $this->getSystemProtocolLimitedRequest($offset, $limit, $id, $lock_id, $medium_id, $event, $user_id, $administrator, $from, $to, $language);
    ...
    /**
     * Operation getSystemProtocolLimitedAsync
     *
     * Gets system protocol.
     *
     * @param  int $offset Offset for paging (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSystemProtocolLimitedAsync($offset = null, $limit = null, $id = null, $lock_id = null, $medium_id = null, $event = null, $user_id = null, $administrator = null, $from = null, $to = null, $language = 'de-DE')
    {
        return $this->getSystemProtocolLimitedAsyncWithHttpInfo($offset, $limit, $id, $lock_id, $medium_id, $event, $user_id, $administrator, $from, $to, $language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSystemProtocolLimitedAsyncWithHttpInfo
     *
     * Gets system protocol.
     *
     * @param  int $offset Offset for paging (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSystemProtocolLimitedAsyncWithHttpInfo($offset = null, $limit = null, $id = null, $lock_id = null, $medium_id = null, $event = null, $user_id = null, $administrator = null, $from = null, $to = null, $language = 'de-DE')
    {
        $returnType = '\Coucounco\Airkey\Swagger\Client\Model\SystemProtocolPagingList';
        $request = $this->getSystemProtocolLimitedRequest($offset, $limit, $id, $lock_id, $medium_id, $event, $user_id, $administrator, $from, $to, $language);
    ...
    /**
     * Create request for operation 'getSystemProtocolLimited'
     *
     * @param  int $offset Offset for paging (optional)
     * @param  int $limit Limit of result size (optional)
     * @param  int $id Filter events by unique protocol entry identifier (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSystemProtocolLimitedRequest($offset = null, $limit = null, $id = null, $lock_id = null, $medium_id = null, $event = null, $user_id = null, $administrator = null, $from = null, $to = null, $language = 'de-DE')
    {
        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling SystemProtocolApi.getSystemProtocolLimited, must be bigger than or equal to 0.');
        }

        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling SystemProtocolApi.getSystemProtocolLimited, must be bigger than or equal to 1.');
        }


        $resourcePath = '/v1/system-protocol-limit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
