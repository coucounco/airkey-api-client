...
/**
 * HolidayCalendarSlot Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HolidayCalendarSlot implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HolidayCalendarSlot';
    ...
    protected static $swaggerTypes = [
        ...
        'valid_from' => 'string',
        'valid_to' => 'string',
        'series' => '\Swagger\Client\Model\HolidayCalendarSeries',
    ...
    public function setSlotName($slot_name)
    {
        if ((mb_strlen($slot_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $slot_name when calling HolidayCalendarSlot., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($slot_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $slot_name when calling HolidayCalendarSlot., must be bigger than or equal to 0.');
        }
     ...
     * Gets series
     *
     * @return \Swagger\Client\Model\HolidayCalendarSeries
     */
     ...
     * Sets series
     *
     * @param \Swagger\Client\Model\HolidayCalendarSeries $series Time series to which this holiday calendar slot is assigned to
     *
     * @return $this
     */
