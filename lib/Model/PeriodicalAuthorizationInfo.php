...
class PeriodicalAuthorizationInfo extends AuthorizationInfo 
{
    ...
    protected static $swaggerTypes = [
        'type' => 'string',
        'periodical_periods' => '\Swagger\Client\Model\PeriodicalPeriod[]',
     ...
     *
     * @return \Swagger\Client\Model\PeriodicalPeriod[]
     */
     ...
     *
     * @param \Swagger\Client\Model\PeriodicalPeriod[] $periodical_periods List of periodical periods in which the medium is authorized for a lock or area (max. 28 entries - 4 per week day)
     *
     * @return $this
     */
