...
class LocksApi
{
     ...
     */
    public function getLocks($offset = null, $limit = null, $calendar_id = null)
    {
        list($response) = $this->getLocksWithHttpInfo($offset, $limit, $calendar_id);
        return $response;
    }
     ...
     */
    public function getLocksWithHttpInfo($offset = null, $limit = null, $calendar_id = null)
    {
        $returnType = '\Swagger\Client\Model\LockPagingList';
        $request = $this->getLocksRequest($offset, $limit, $calendar_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLocksAsync($offset = null, $limit = null, $calendar_id = null)
    {
        return $this->getLocksAsyncWithHttpInfo($offset, $limit, $calendar_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLocksAsyncWithHttpInfo($offset = null, $limit = null, $calendar_id = null)
    {
        $returnType = '\Swagger\Client\Model\LockPagingList';
        $request = $this->getLocksRequest($offset, $limit, $calendar_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getLocksRequest($offset = null, $limit = null, $calendar_id = null)
    {
     ...
     *
     * @param  int $lock_id Unique identifier of the lock (required)
     * @param  \Swagger\Client\Model\Lock $body Lock to be updated (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Lock
