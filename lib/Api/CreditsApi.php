...
class CreditsApi
{
     ...
     * @return \Swagger\Client\Model\CreditInfo
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CreditInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreditsWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\CreditInfo';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CreditInfo',
