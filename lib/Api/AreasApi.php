...
class AreasApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Area, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAreaWithHttpInfo($area_id)
    {
        $returnType = '\Swagger\Client\Model\Area';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AreaPagingList
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AreaPagingList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAreasWithHttpInfo($lock_id = null, $offset = null, $limit = null)
    {
        $returnType = '\Swagger\Client\Model\AreaPagingList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AreaPagingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
